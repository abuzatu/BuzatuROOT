...
if total<4:
    ...
    print "Ex: ./readHisto.py fit plotType callibration1 callibration2 ..."
    print "Ex: ./readHisto.py Bukin hist OneMu Parton PtRecoGauss"
    print "Ex: ./reaHisto.py  Gauss overlay Nominal OneMuNu"
    print "Ex: ./readHisto.py Gauss fit AllMuNu"
    assert(False)
# done if
...
ncallibs=total-3
calliblist=[None]*ncallibs
j=0
for i in range(3,total):
    callibName=sys.argv[i]
    callibration=str(callibName)
    calliblist[j]=callibration
    j+=1
